const state = {
    ...
    autoClick: 0,
    upgrades: [
      { name: "Clic puissance", cost: 10, value: 1, type: "click", level: 0 },
  ...
  function render() {
    document.getElementById("clicks").textContent = `Clics: ${state.clicks}`;
    document.getElementById("cps").textContent = `Clics par seconde: ${state.autoClick}`;
